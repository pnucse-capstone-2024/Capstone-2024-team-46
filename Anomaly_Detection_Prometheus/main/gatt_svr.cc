...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    {
        ...
        { {
                ...
                .arg = NULL,  /* Optional argument, set to NULL or appropriate value */
...
#endif
                .min_key_size = 0,  /* Default value or set as required */
                .val_handle = &gatt_svr_chr_val_handle,
                .cpfd = NULL,       /* Default value or set as required */
            }, {
                ...
                struct ble_gatt_access_ctxt *ctxt, void *arg)
{
    ...
    case BLE_GATT_ACCESS_OP_READ_CHR:
        if (conn_handle != BLE_HS_CONN_HANDLE_NONE) {
            //MODLOG_DFLT(INFO, "Read heading : %s", gatt_svr_chr_val);
        } else {
            //MODLOG_DFLT(INFO, "Read(nofity) heading : %s", gatt_svr_chr_val);
        }
        uuid = ctxt->chr->uuid;
    ...
    case BLE_GATT_ACCESS_OP_WRITE_CHR:
        if (conn_handle != BLE_HS_CONN_HANDLE_NONE) {
            //MODLOG_DFLT(INFO, "Write heading : %s", gatt_svr_chr_val);
        } else {
            //MODLOG_DFLT(INFO, "Write(nofity) heading : %s", gatt_svr_chr_val);
        }
        uuid = ctxt->chr->uuid;
        if (attr_handle == gatt_svr_chr_val_handle) {
